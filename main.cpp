...
int main() 
{
	...
	skyboxFaces.push_back("Textures/Skybox/devils-tooth_rt.tga");
	skyboxFaces.push_back("Textures/Skybox/devils-tooth_lf.tga");
	skyboxFaces.push_back("Textures/Skybox/devils-tooth_up.tga");
	skyboxFaces.push_back("Textures/Skybox/devils-tooth_dn.tga");
	skyboxFaces.push_back("Textures/Skybox/devils-tooth_bk.tga");
	skyboxFaces.push_back("Textures/Skybox/devils-tooth_ft.tga");
